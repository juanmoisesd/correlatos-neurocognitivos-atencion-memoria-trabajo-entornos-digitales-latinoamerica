...
def publish_to_zenodo():
    ...
    # 2. Upload files
    files = glob.glob('results/policy_briefs/pdf/*.pdf')
    ...
    data = {
        'metadata': {
            'title': 'Policy Briefs sobre Neurociencia y Políticas Públicas',
            'upload_type': 'publication',
            'publication_type': 'report',  # Changed from 'policy-brief' which was invalid
            'description': 'Serie de 10 policy briefs sobre diversos temas de neurociencia aplicada a políticas públicas redactados por Juan Moisés de la Serna.',
