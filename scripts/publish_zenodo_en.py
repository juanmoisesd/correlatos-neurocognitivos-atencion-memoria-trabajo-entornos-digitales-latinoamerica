...
def publish_to_zenodo():
    ...
    # 2. Upload English Academic PDFs
    files = glob.glob('results/policy_briefs/en/pdf/*.pdf')
    ...
    # 3. Add metadata (Academic English)
    data = {
        'metadata': {
            'title': 'Academic Policy Briefs: Neuroscience and Governance (Series I)',
            'upload_type': 'publication',
            'publication_type': 'report',
            'description': 'A collection of 10 extensive academic policy briefs exploring the integration of affective and social neuroscience into public policy, health, and education. Authored by Juan Moises de la Serna.',
            'creators': [{'name': 'de la Serna, Juan Moises',
                          'affiliation': 'Universidad Internacional de La Rioja (UNIR)',
                          'orcid': '0000-0002-8401-8018'}],
            'access_right': 'open',
            'license': 'cc-by-4.0',
            'keywords': ['Neuroscience', 'Public Policy', 'Emotional Architecture', 'Neuroplasticity', 'Governance', 'Mental Health']
        }
    }
